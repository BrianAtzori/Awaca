...
export default function App() {
  return (
    ...
    <Routes>
      ...
      <Route path="how-to-meditate"  element={<HowToMeditate></HowToMeditate>}></Route>
      <Route path="why-you-should-meditate"  element={<WhyYouShouldMeditate></WhyYouShouldMeditate>}></Route>
