...
export default function Card({featuredImage, cardLink, linkName}) {
  return (
    <div className=' bg-palette-color-whitesmoke  p-4 flex flex-col gap-4 rounded-xl font-lato shadow-2xl border-opacity-20 border-2 border-palette-color-dark-blue over'>
